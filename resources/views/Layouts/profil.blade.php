...
<head>
    ...
    <link href="{{ asset('geomuda.png') }}" rel="icon">
    ...
    <link href="{{ asset('static/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('static/css/ruang-admin.min.css') }}" rel="stylesheet">
