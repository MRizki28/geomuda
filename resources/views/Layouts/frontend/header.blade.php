            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="owl-carousel   position-relative d-inline-flex align-items-center ml-3"
                    ...
                    <marquee>Perusahaan Maritim Muda Nusantara baru saja meluncurkan website
                        sertifikasi yang bernama Becdex.com Gubergren elitr amet eirmod et lorem diam elitr, ut est erat
                        Gubergren
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="mb-2 mt-n2 display-5 text-uppercase"><span class="text-primary">Geo</span>muda</h1>
                </a>
